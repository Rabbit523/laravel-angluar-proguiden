    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
          <h1>NextGenTel AS</h1>
          <p>Internett over bredbånd dekker behovet til de fleste.
            <br> Med bredbånd kan du lytte til musikk, spille eller streame film.</p>
        </div>
          ...
          <div class="col-xs-12 col-sm-4 col-md-3">
            <div class="sidebar-left">
              ...
              <div class="options text-center">
                ...
                <span>
                  <img src="{{ asset('/assets/images/star.png', env('REDIRECT_HTTPS')) }}" class="img-responsive center-block" alt="">
                </span>
                <span>
                  <img src="{{ asset('/assets/images/coin.png', env('REDIRECT_HTTPS')) }}" class="img-responsive center-block" alt="">
                </span>
              </div>
              <div class="clearfix"></div>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3">
          <div class="deal">
            ...
            <div class="options text-center">
              <span>
                <a href="" data-toggle="tooltip" title="12 måneder bindingstid" data-placement="bottom">
                  <img src="{{ asset('/assets/images/lock.png', env('REDIRECT_HTTPS')) }}" class="img-responsive center-block" alt="">
                </a>
              </span>
              <span>
                <a href="" data-toggle="tooltip" title="Kampanjepris: 299,-" data-placement="bottom">
                  <img src="{{ asset('assets/images/star.png', env('REDIRECT_HTTPS')) }}" class="img-responsive center-block" alt="">
                </a>
              </span>
              <span>
                <a href="" data-toggle="tooltip" title="Startskostnad: 99 kr" data-placement="bottom">
                  <img src="{{ asset('assets/images/coin.png', env('REDIRECT_HTTPS')) }}" class="img-responsive center-block" alt="">
                </a>
              </span>
            </div>
