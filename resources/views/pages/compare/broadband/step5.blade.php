        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-10 col-md-10 col-lg-8">
                    <h1>BesTakk for din bestilling!till</h1>
                        ...
                        <div class="title-table">
                            <div class="row">
                                <div class="col-xs-12 col-sm-10">
                                    <p>NextGenTel AS</p>
                                    <h3>ADSL Bredbånd 20</h3>
                                </div>
                                <div class="col-xs-12 col-sm-2">
                                    <img src="{{ asset('assets/images/nextgentel.png', env('REDIRECT_HTTPS')) }}" class="img-responsive">
                                </div>
                            </div>
                        </div>
                        <h4>Personalia</h4>
            ...
            <div class="other-services">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3">
                        <article class="service">
                            <figure>
                                <a href=""><i class="icon-proguiden-electricity"></i></a>
                            </figure>
                            <h3>
                            <a href="">Strøm</a>
                            </h3>
